...
const SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "pricing_method", type: "select", label: "How do you calculate pricing for a custom job?",
        options: ["POS software calculates it", "I use a formula/spreadsheet", "United Inch method", "I price by feel/experience", "Combination of methods"] },
